...
<?php
    ...
    if(isset($_GET['id']))
    {
        ...
        //get the individuel values of selected food
        $title = $row2['title'];
    ...
    <div class="wrapper">
        ...
        <?php
            if(isset($_POST['submit']))
            {
                ...
                ///check whether  upload button in clicked or not
                if(isset($_FILES['image']['name']))
                {
                    ...
                    if($image_name!="")
                    {
                        ...
                        //get the sorce and destination path
                        ...
                        //remove current image if avaible
                        if($current_image!="")
                        {
                            ...
                            //chack whether the image is removed or not
                            if($remove==false)
                            {
