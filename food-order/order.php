        ...
        <div class="container">
            ...
            <form action="" method="POST" class="order">
                <fieldset>
                    ...
                    <div class="food-menu-img">
                        <?php
                            ...
                            {
                                //image not available
                                echo "<dic class='error'>Image not Available.</dic>";
                            }
                            else
                            {
                                //image is available
                ...
                <fieldset>
                    ...
                    <input type="text" name="full-name" placeholder="E.g. Anouar Kharef" class="input-responsive" required>

                    <div class="order-label">Phone Number</div>
                    <input type="tel" name="contact" placeholder="E.g. 055xxxxxxx" class="input-responsive" required>
            ...
            <?php 
                ...
                {
                    //get all the details fro the form
                    $food= $_POST['food'];
                    $price = $_POST['price'];
